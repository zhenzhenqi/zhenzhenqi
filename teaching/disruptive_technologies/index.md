...
<img src="{{ '/assets/imported/teaching/disruptive_technologies/ai-image-analyzer-1.png' | relative_url }}" alt="OpenAI API Image Analyzer mobile interface displaying a photographed user and an AI-generated visual and fashion analysis" loading="lazy" decoding="async" style="width: 66.6667%; height: auto;">
<img src="{{ '/assets/imported/teaching/disruptive_technologies/ai-image-analyzer-2.jpg' | relative_url }}" alt="Unity editor showing the OpenAI API Image Analyzer mobile application in development" loading="lazy" decoding="async">
<img src="{{ '/assets/imported/teaching/disruptive_technologies/ai-image-analyzer-3.png' | relative_url }}" alt="Visual Studio Code displaying the Unity C-sharp integration used to send images to the OpenAI API" loading="lazy" decoding="async">
