...
<br>
*AI Image Analyzer*, by Musawir, is a mobile application which captures live images via webcam (Android front/back camera), sends the image to the OpenAI API (GPT-4o with Vision) for analysis, and displays the AI’s response back to the user in real-time.​ It explores the possibilities of integrated AI vision capabilities within a mobile application environment (Unity) and its potential uses. ​
